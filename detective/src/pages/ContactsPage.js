...
export default function ContactsPage() {
    ...
    return <>
            ...
            <div className="about-us-block">
                ...
                <div className="about-us-right">
                    ...
                    <div className="about-us-block__text">
                        <p><img className='about-us-block__text-img' src={mapFlagIcon} alt="mapFlag" /> Санкт-Петербург, ул. Мебельная д. 1 этаж 2 офис 7</p>
                        <p><img className='about-us-block__text-img' src={mapFlagIcon} alt="mapFlag" /> Санкт-Петербург, Гражданский проспект 41 к.2 "Академ-Парк"</p>
                        <p><img className='about-us-block__text-img' src={emailContactsIcon} alt="emailContactsIcon" /> Наша почта : <a href={'mailto:detectiveok@ya.ru'}>detectiveok@ya.ru</a> </p>
                        <p><img className='about-us-block__text-img' src={phoneIcon} alt="phoneIcon" /> Позвоните нам : <a href={'tel:+79210999007'}>+7(921)099-90-07</a></p>
                        <p><b><img className='about-us-block__text-img' src={clockIcon} alt="clockIcon" /> Работаем круглосуточно</b></p>
                    </div>
        ...
        <section className="maps-section">
            <div className="main-section-title section-title-text">Как нас найти?</div>
            <YandexMap />
        </section>
    </>
}